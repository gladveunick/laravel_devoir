    ...
    <div class="main--content">
        ...
        <div class="tabular--wrapper">
            ...
            <div class="table-container">
                ...
                <a href="{{ route('admin.programmes.create') }}" class="btnAjout"><i class="fas fa-plus"></i> Ajouter programme
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $programme->candidat->nom }} {{ $programme->candidat->prenom }}</td>
                            <td class="btn-boutton">
                                <a href="{{ route('admin.programmes.edit', $programme->id) }}" class="btnEditer">Editer </a>
...
<div class="container mt-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('admin.programmes.destroy', $programme->id) }}" method="post">
                        @csrf
                        <a href="{{ route('admin.programmes.edit', $programme->id) }}" class="btn btn-primary">Modifier</a>
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger">Supprimer</button>
                    </form>
                </td>
    ...
    <a href="{{ route('admin.programmes.create') }}" class="btn btn-success">Ajouter un Programme</a>
